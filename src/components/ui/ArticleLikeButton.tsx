...
/* ─────────────────────────────────────────
   ArticleLikeButton — 활성 색상: primary-700 (#1F4D3A)
───────────────────────────────────────── */
 ...
 *   />
 */
export function ArticleLikeButton({ isLiked, count, onToggle }: ArticleLikeButtonProps) {
  return (
    <LikeButtonBase
      isLiked={isLiked}
      count={count}
